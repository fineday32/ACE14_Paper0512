...
Fun/enjoyment included game enjoyment rating and description of the game experience (users selected keywords about their feeling), curiosity showed that the users were curious about the games (on a scale of 1 to 5), and co-experience were the feeling of interacting with each other (users selected keywords about their feeling).


is created in social contexts, when people interact with each other
