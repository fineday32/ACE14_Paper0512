...
In this work, we propose an innovative communication way by using body language in cooperative game design. We also complete a game prototype, Mute Robot, to evaluate and confirm our game design guideline. We conduct a user study for 24 groups within 48 users. Results indicate that body language is greatly suitable for cooperative game design, which also directly proved that our design is not only success but also provides a better game play environment. In the future, game developer can make a better game experience with these design guidelines. 
